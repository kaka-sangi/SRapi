...
- 新增 4 个 smoke：
  ...
  4. `smoke-quality-eval`：已落地为 `make smoke-quality-eval`，使用本地 judge 验证 QualityEval sample capture、worker evaluation 和 Scheduler quality evidence；真实外部 judge 比例 smoke 仍需生产凭证
