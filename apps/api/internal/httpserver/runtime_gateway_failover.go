...
func gatewayShouldFailover(errorClass string, upstreamStatus int, attemptNo int, candidateCount int) bool {
	...
	switch errorClass {
	case "rate_limit", "timeout", "network_error", "provider_5xx", "model_unavailable", "credential_error", "auth_failed", "auth_error", "permission_denied", "session_invalid", "account_locked", "account_banned", "abuse_detected", "device_unrecognized", "stream_interrupted":
		return true
	default:
		return false
	}
