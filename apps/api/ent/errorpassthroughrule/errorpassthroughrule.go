...
const (
	...
	FieldAction = "action"
	// FieldMatchStatusCodes holds the string denoting the match_status_codes field in the database.
	FieldMatchStatusCodes = "match_status_codes"
	// FieldMatchClasses holds the string denoting the match_classes field in the database.
