...
var (
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ModelRegistriesColumns[3]},
			},
			{
				Name:    "modelregistry_family",
				Unique:  false,
				Columns: []*schema.Column{ModelRegistriesColumns[5]},
			},
			{
				Name:    "modelregistry_status",
				Unique:  false,
				Columns: []*schema.Column{ModelRegistriesColumns[9]},
			},
		},
	}
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{PaymentProviderInstancesColumns[3], PaymentProviderInstancesColumns[4]},
			},
			{
				Name:    "paymentproviderinstance_provider_status",
				Unique:  false,
				Columns: []*schema.Column{PaymentProviderInstancesColumns[3], PaymentProviderInstancesColumns[5]},
			},
			{
				Name:    "paymentproviderinstance_status_sort_order",
				Unique:  false,
				Columns: []*schema.Column{PaymentProviderInstancesColumns[5], PaymentProviderInstancesColumns[10]},
			},
		},
	}
	...
	ProviderAccountsColumns = []*schema.Column{
		...
		{Name: "rate_limited_at", Type: field.TypeTime, Nullable: true},
		{Name: "rate_limit_reset_at", Type: field.TypeTime, Nullable: true},
		{Name: "overload_until", Type: field.TypeTime, Nullable: true},
		{Name: "temp_unschedulable_until", Type: field.TypeTime, Nullable: true},
		{Name: "temp_unschedulable_reason", Type: field.TypeString, Default: ""},
		{Name: "session_window_start", Type: field.TypeTime, Nullable: true},
		{Name: "session_window_end", Type: field.TypeTime, Nullable: true},
		{Name: "session_window_status", Type: field.TypeString, Default: ""},
		{Name: "extra_json", Type: field.TypeJSON, Nullable: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[4], ProviderAccountsColumns[13]},
			},
			{
				Name:    "provideraccount_status_priority",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[13], ProviderAccountsColumns[14]},
			},
			{
				Name:    "provideraccount_platform_status",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[6], ProviderAccountsColumns[13]},
			},
			{
				Name:    "provideraccount_platform_priority",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[6], ProviderAccountsColumns[14]},
			},
			{
				Name:    "provideraccount_schedulable",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[22]},
			},
			{
				Name:    "provideraccount_expires_at",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[25]},
			},
			{
				Name:    "provideraccount_rate_limited_at",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[27]},
			},
			{
				Name:    "provideraccount_rate_limit_reset_at",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[28]},
			},
			{
				Name:    "provideraccount_overload_until",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[29]},
			},
			{
				Name:    "provideraccount_last_used_at",
				Unique:  false,
				Columns: []*schema.Column{ProviderAccountsColumns[24]},
			},
		},
	}
	...
	ProxiesColumns = []*schema.Column{
		...
		{Name: "password_ciphertext", Type: field.TypeBytes, Nullable: true},
		...
		{Name: "expiry_warn_days", Type: field.TypeInt, Default: 0},
	...
	ProxiesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ProxiesColumns[4], ProxiesColumns[12]},
			},
			{
	...
	WorkspacesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{WorkspacesColumns[5], WorkspacesColumns[7]},
			},
			{
