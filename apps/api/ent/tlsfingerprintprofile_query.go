...
func (_q *TLSFingerprintProfileQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *TLSFingerprintProfileQuery) FirstIDX(ctx context.Context) int {
...
func (_q *TLSFingerprintProfileQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *TLSFingerprintProfileQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *TLSFingerprintProfileQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *TLSFingerprintProfileQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TLSFingerprintProfileQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(tlsfingerprintprofile.Table, tlsfingerprintprofile.Columns, sqlgraph.NewFieldSpec(tlsfingerprintprofile.FieldID, field.TypeInt))
	_spec.From = _q.sql
