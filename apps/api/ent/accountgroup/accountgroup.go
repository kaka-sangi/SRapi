...
const (
	...
	// FieldProviderScopeJSON holds the string denoting the provider_scope_json field in the database.
	FieldProviderScopeJSON = "provider_scope_json"
	// FieldModelScopeJSON holds the string denoting the model_scope_json field in the database.
