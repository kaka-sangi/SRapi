...
func (_q *UserAttributeDefinitionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserAttributeDefinitionQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserAttributeDefinitionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserAttributeDefinitionQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserAttributeDefinitionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserAttributeDefinitionQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserAttributeDefinitionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userattributedefinition.Table, userattributedefinition.Columns, sqlgraph.NewFieldSpec(userattributedefinition.FieldID, field.TypeInt))
	_spec.From = _q.sql
