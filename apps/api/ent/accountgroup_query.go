...
func (_q *AccountGroupQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *AccountGroupQuery) FirstIDX(ctx context.Context) int {
...
func (_q *AccountGroupQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *AccountGroupQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *AccountGroupQuery) IDs(ctx context.Context) (ids []int, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(accountgroup.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *AccountGroupQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AccountGroupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(accountgroup.Table, accountgroup.Columns, sqlgraph.NewFieldSpec(accountgroup.FieldID, field.TypeInt))
	_spec.From = _q.sql
