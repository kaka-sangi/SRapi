...
func (*EmailVerificationToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case emailverificationtoken.FieldTokenHash, emailverificationtoken.FieldTokenVersion:
			values[i] = new(sql.NullString)
		case emailverificationtoken.FieldCreatedAt, emailverificationtoken.FieldUpdatedAt, emailverificationtoken.FieldExpiresAt, emailverificationtoken.FieldUsedAt:
...
func (_m *EmailVerificationToken) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case emailverificationtoken.FieldTokenVersion:
			if value, ok := values[i].(*sql.NullString); !ok {
