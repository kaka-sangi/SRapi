...
func (_c *UserAttributeValueCreate) SetDefinitionID(v int) *UserAttributeValueCreate {
...
func (_c *UserAttributeValueCreate) check() error {
	...
	if _, ok := _c.mutation.DefinitionID(); !ok {
		return &ValidationError{Name: "definition_id", err: errors.New(`ent: missing required field "UserAttributeValue.definition_id"`)}
	}
	if _, ok := _c.mutation.Value(); !ok {
