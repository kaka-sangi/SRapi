...
func (_q *UserPlatformQuotaQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserPlatformQuotaQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserPlatformQuotaQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserPlatformQuotaQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserPlatformQuotaQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserPlatformQuotaQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserPlatformQuotaQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userplatformquota.Table, userplatformquota.Columns, sqlgraph.NewFieldSpec(userplatformquota.FieldID, field.TypeInt))
	_spec.From = _q.sql
