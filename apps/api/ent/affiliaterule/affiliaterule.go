...
const (
	// Label holds the string label denoting the affiliaterule type in the database.
	Label = "affiliate_rule"
	...
	// Table holds the table name of the affiliaterule in the database.
	Table = "affiliate_rules"
)

// Columns holds all SQL columns for affiliaterule fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	DefaultRate string
	// DefaultFixedAmount holds the default value on creation for the "fixed_amount" field.
	...
	DefaultMaxRebateAmount string
)

// OrderOption defines the ordering options for the AffiliateRule queries.
...
// ByFixedAmount orders the results by the fixed_amount field.
func ByFixedAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFixedAmount, opts...).ToFunc()
}
