...
func (_c *WorkspaceCreate) SetOwnerUserID(v int) *WorkspaceCreate {
	_c.mutation.SetOwnerUserID(v)
	return _c
}

// SetNillableOwnerUserID sets the "owner_user_id" field if the given value is not nil.
func (_c *WorkspaceCreate) SetNillableOwnerUserID(v *int) *WorkspaceCreate {
	if v != nil {
		_c.SetOwnerUserID(*v)
	}
	return _c
...
func (_c *WorkspaceCreate) SetType(v string) *WorkspaceCreate {
	_c.mutation.SetType(v)
	return _c
}

// SetNillableType sets the "type" field if the given value is not nil.
func (_c *WorkspaceCreate) SetNillableType(v *string) *WorkspaceCreate {
	if v != nil {
		_c.SetType(*v)
	}
	return _c
...
func (_c *WorkspaceCreate) SetMetadataJSON(v map[string]interface{}) *WorkspaceCreate {
...
func (_c *WorkspaceCreate) check() error {
	...
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "Workspace.type"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
