...
func (_q *ErrorPassthroughRuleQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ErrorPassthroughRuleQuery) FirstIDX(ctx context.Context) int {
...
func (_q *ErrorPassthroughRuleQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ErrorPassthroughRuleQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *ErrorPassthroughRuleQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *ErrorPassthroughRuleQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ErrorPassthroughRuleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(errorpassthroughrule.Table, errorpassthroughrule.Columns, sqlgraph.NewFieldSpec(errorpassthroughrule.FieldID, field.TypeInt))
	_spec.From = _q.sql
