...
export const en = {
  ...
  billing: {
    ...
    setupStep1: "Settings → Features → enable \"Payments enabled\"",
    setupStep2: "Settings → Payment → enable \"Activate payment processing\" + select providers",
    setupStep3: "Billing Admin → Payment Providers → create & activate a provider instance",
