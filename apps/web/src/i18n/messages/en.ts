...
export const en = {
  common: {
    ...
    "generic-reverse-proxy": "Generic Reverse Proxy",
    "anthropic-compatible": "Anthropic Compatible",
    "gemini-compatible": "Gemini Compatible",
    "rerank-compatible": "Rerank Compatible",
    limited: "Limited",
    all: "All",
    off: "Off",
    refresh: "Refresh",
  ...
  apiKeys: {
    ...
    onboardingStep1Title: "Copy the base URL",
    onboardingStep1Body: "Point your SDK at this gateway instead of the provider's host.",
    onboardingStep2Title: "Paste the key",
    onboardingStep2Body: "Authorize requests with a Bearer header — the key is only ever sent here.",
    onboardingStep3Title: "Watch usage land",
  ...
  availableChannels: {
    ...
    overall_degraded: "Some systems experiencing issues",
    overall_outage: "Major outage in progress",
    overallSub: "{available} of {total} models fully available",
  ...
  adminAccounts: {
    ...
    allRuntimeClasses: "All types",
    searchPlaceholder: "Search by name, upstream client, or ID…",
    runtimeClassLabel: {
      api_key: "API key",
      oauth_refresh: "OAuth refresh",
      oauth_device_code: "OAuth device code",
      web_session_cookie: "Web session",
    ...
    usagePeriod: "Active range",
    activeUsageRange: "Active range",
    activeUsageDaysLabel: "Active days",
    activeUsageDays: "{count} days",
    endpointOverrides: "Endpoint overrides",
    inheritProvider: "Inherit provider",
    capabilityForcedOn: "On",
    capabilityForcedOff: "Off",
    ...
    morePlatforms: "More",
    accountTypeSelect: "Account type",
    "typeHint.apikey": "Console API key",
    "typeHint.oauth": "Browser login",
    addMethod: "Add method",
    oauthAuthorize: "OAuth authorize",
    oauthAuthorizeHint: "Open provider login page in a browser to authorize.",
    setupToken: "Setup Token (long-lived)",
    setupTokenLabel: "Setup Token",
    setupTokenPlaceholder: "Paste your setup token from claude.ai/settings/tokens",
    setupTokenHint: "Get it from claude.ai → Settings → API → Setup Token. Long-lived, no refresh needed.",
    alsoCreateChatGPTWeb: "Also create ChatGPT Web account",
    alsoCreateChatGPTWebHint: "Reuse the same token for image generation (gpt-image-2). Codex and Web quotas are independent.",
    chatgptWebCreated: "ChatGPT Web account created (image generation)",
    chatgptWebFailed: "Failed to create ChatGPT Web account (you can create it manually later)",
    refreshTokenPlaceholder: "Paste refresh_token or JSON containing tokens.refresh_token...",
    refreshTokenHint: "SRapi will automatically refresh the access_token when using this account.",
    "quota.title": "Quota control",
    "quota.hint": "Limit per-account usage by total, daily, or weekly quotas.",
    "quota.total": "Total limit",
    "quota.daily": "Daily limit",
    "quota.weekly": "Weekly limit",
    "quota.resetTimezone": "Reset timezone",
    "quota.windowCost": "Window cost ($)",
    "quota.windowCostHint": "Max cost per scheduling window.",
    "quota.maxSessions": "Max sessions",
    "tempUnsched.title": "Auto-pause rules",
    "tempUnsched.hint": "Temporarily pause scheduling on specific upstream errors.",
    "tempUnsched.errorCode": "HTTP code",
    "tempUnsched.keywords": "Keywords",
    "tempUnsched.duration": "Minutes",
    "tempUnsched.desc": "Description",
    "tempUnsched.addRule": "Add rule",
    "poolMode.title": "Pool mode",
    "poolMode.hint": "Distribute requests across multiple credentials in this account.",
    "poolMode.enabledHint": "Requests will be load-balanced; failed credentials auto-retry with another.",
    "poolMode.retryCount": "Max retries",
    "poolMode.retryCodes": "Retry status codes",
    "allowedClients.title": "Client restriction",
    "allowedClients.hint": "Only allow specific official CLI clients to use this account.",
    "openaiCaps.title": "OpenAI capabilities",
    "openaiCaps.chatCompletions": "Chat Completions / Responses",
    "openaiCaps.embeddings": "Embeddings",
    "openaiCaps.responsesMode": "Responses mode",
    "openaiCaps.auto": "Auto",
    "openaiCaps.wsMode": "WebSocket mode",
    "openaiCaps.wsOff": "Off",
    "openaiCaps.wsCtxPool": "Context pool",
    "openaiCaps.wsPassthrough": "Passthrough",
    "antigravity.title": "Antigravity",
    "antigravity.mixedScheduling": "Mixed scheduling",
    "antigravity.mixedSchedulingHint": "Allow scheduling alongside accounts from other platforms.",
    "antigravity.allowOverages": "Allow overages",
    "antigravity.allowOveragesHint": "Continue serving requests after AI Credits quota is exhausted.",
    "modelSelector.sync": "Sync from upstream",
    "modelSelector.syncDone": "Added {count} models from upstream",
    "modelSelector.syncNoNew": "All upstream models already added",
    "bedrock.authMode": "Auth mode",
    "bedrock.region": "AWS Region",
    "bedrock.sessionToken": "Session Token (optional)",
    "bedrock.sessionTokenHint": "Temporary credentials only",
    "vertex.saJson": "Service Account JSON",
    ...
    proxySelect: "Proxy",
    proxySelectPlaceholder: "Select proxy",
    ...
    bindProxyHelp:
      "Route this account's egress through an outbound proxy. Leave empty to send requests directly from the gateway.",
    proxy: "Proxy",
    ...
    manualPauseAction: "Pause scheduling…",
    manualPausePrompt: "Skip this account in scheduling for how many minutes? (1-1440)",
    manualPauseInvalid: "Pause duration must be 1-1440 minutes",
    manualPauseDone: "Account skipped until {until}",
    manualResumeAction: "Resume scheduling",
    manualResumeDone: "Scheduling pause cleared",
    manualPauseUntilBadge: "Paused until {until}",
  ...
  accountOAuth: {
    ...
    authCodeIntro:
      "Generate an authorization URL, sign in with the provider, then paste the returned callback URL or authorization/setup code.",
    deviceIntro:
    ...
    stepOpenHint: "Sign in on the provider page, approve access, and copy the callback URL or returned code.",
    stepCodeTitle: "Paste callback URL or code",
    clientId: "Client ID",
    ...
    pasteCodeHint: "After consenting, paste the full redirect URL, or only the 'code' value.",
    callbackCode: "Callback URL / code",
  ...
  adminGatewayResources: {
    ...
    defaultSort: "Troubleshoot first",
    ...
    traffic: "Traffic",
    trafficWindow: "Last {hours}h",
    trafficRequests: "{count} req",
    trafficErrors: "{count} err",
    trafficSuccessRate: "success {rate}",
    trafficLastRequest: "last {time}",
    trafficLastErrorShort: "last {error}",
    trafficLastError: "last error {error} at {time}",
    trafficLastErrorMessage: "message {message}",
    trafficLastErrorRequest: "request {request}",
    trafficLastErrorUpstreamRequest: "upstream request {request}",
    noRecentTraffic: "no recent traffic",
    ...
    sort: {
      riskDesc: "Troubleshoot first",
      riskAsc: "Healthy first",
      errorsDesc: "Most errors",
      errorsAsc: "Fewest errors",
      trafficDesc: "Most traffic",
      trafficAsc: "Least traffic",
      nameDesc: "Name Z-A",
      nameAsc: "Name A-Z",
    },
    fixReason: {
  ...
  adminProviders: {
    ...
    bulkDisableTitle: "Disable {count} providers?",
    bulkDisableBody: "Selected providers will stop receiving traffic until re-enabled.",
    bulkArchiveTitle: "Archive {count} providers?",
    bulkArchiveBody: "Archived providers are excluded from scheduling. Their accounts remain untouched.",
    bulkDeleteTitle: "Delete {count} providers?",
    bulkDeleteBody: "Selected providers will be permanently removed. Providers with active accounts cannot be deleted. This cannot be undone.",
  },
  adminModels: {
    title: "Models",
    ...
    bulkArchive: "Archive selected",
    bulkDelete: "Delete selected",
    bulkDisableTitle: "Disable {count} models?",
    bulkDisableBody: "Selected models will stop receiving traffic until re-enabled.",
    bulkArchiveTitle: "Archive {count} models?",
    bulkArchiveBody: "Archived models are hidden from callers and excluded from scheduling. Past usage records are kept.",
    bulkDeleteTitle: "Delete {count} models?",
    bulkDeleteBody: "Selected models and their aliases and provider mappings will be permanently removed. Past usage records are kept. This cannot be undone.",
  },
  adminProxies: {
    title: "Proxies",
  ...
  adminRoles: {
    ...
    permissionsBreakdown: "Permissions granted",
    permissionsReadCount: "Read",
    permissionsWriteCount: "Write",
    metadata: "Metadata",
  ...
  adminOps: {
    ...
    latencyHistogramEmpty: "No latency samples yet",
    errorDistribution: "Error distribution",
    errorDistributionEmpty: "No errors in window",
    errorsTotal: "errors",
    owner: { provider: "Provider", client: "Client", platform: "Platform", other: "Other" },
  ...
  adminRisk: {
    ...
    moderationEnabled: "OpenAI moderation",
    moderationEnabledHint: "Adds the OpenAI /v1/moderations classifier on top of the local regex pass.",
    moderationModel: "Moderation model",
    moderationBaseUrl: "Moderation base URL",
    moderationApiKey: "Moderation API key",
    moderationApiKeyPlaceholder: "Paste a new key to rotate, leave empty to keep stored key",
    moderationApiKeyHint: "Stored encrypted. Empty preserves the current key.",
    moderationBlockOnFlag: "Block flagged requests (enforce mode)",
    moderationBlockOnFlagHint: "Requires mode=enforce. Monitor mode only records the verdict.",
    moderationTimeoutMs: "Upstream timeout (ms)",
    moderationCacheTtlSeconds: "Cache TTL (seconds)",
    moderationCacheTtlHint: "0 disables the in-process response cache.",
  },
  adminUsage: {
    title: "Usage",
    ...
    trendEmpty: "No usage in window",
    errorDistributionTitle: "Error distribution",
    errorDistributionEmpty: "No errors in window",
    errorsTotal: "errors",
    errorsOther: "Other",
    distributionTitle: "Usage distribution",
    distributionEmpty: "No usage in window",
    metric: { requests: "Requests", cost: "Cost" },
    bucket: { day: "Day", hour: "Hour" },
    dimension: { model: "Model", requested_model: "Requested model", upstream_model: "Upstream model", account: "Account", provider: "Provider", api_key: "API key", source_endpoint: "Endpoint", billing_mode: "Billing mode", user: "User" },
    estimated: "Estimated",
    exact: "Exact",
  ...
  adminSettings: {
    ...
    customMenusHint: "Sidebar links shown under Links. Internal links must start with /; external links must use http(s).",
    customMenusEmpty: "No custom sidebar links.",
    addCustomMenu: "Add link",
    customMenuItem: "Link {n}",
    customMenuMoveUp: "Move up",
    customMenuMoveDown: "Move down",
    customMenuRemove: "Remove link",
    customMenuFields: {
      label: "Label",
      url: "URL",
    ...
    oauthFields: {
      ...
      clientId: "Client ID",
      clientSecret: "Client Secret",
      secretConfigured: "Secret configured — leave blank to keep",
    ...
    captcha: {
      title: "CAPTCHA",
      hint: "Runtime login and registration challenge settings. Secrets are write-only.",
      managed: "Managed in console",
      managedHint: "Override the deployment environment CAPTCHA configuration.",
      enabled: "Require challenge",
      enabledHint: "Enforce human verification on sign-in, sign-up, and passwordless requests.",
      provider: "Provider",
      siteKey: "Site key",
      secretKey: "Secret key",
      secretConfigured: "Secret key is configured",
      secretPlaceholder: "Paste a new secret key",
      secretHint: "Leave blank to keep the stored secret.",
      verifyURL: "Verify URL",
      secretStatusConfigured: "Secret configured",
      secretStatusMissing: "Secret missing",
      saved: "CAPTCHA saved",
      unsaved: "Unsaved CAPTCHA changes",
    ...
    general: {
      branding: "Branding",
      brandingHint: "Site identity shown in the header, browser tab, and public pages.",
      logoHint: "Absolute URL to a square logo image (PNG/SVG recommended).",
      links: "Links & Contact",
      linksHint: "Help links and support contact shown in the footer and sidebar.",
      customMenus: "Custom Sidebar Links",
    },
    agreement: {
      title: "Legal Documents",
      hint: "User-facing terms shown during registration and in the account settings. Supports Markdown.",
      userAgreementHint: "Terms of service or acceptable-use policy. Displayed as a required checkbox during sign-up.",
      userAgreementPlaceholder: "Enter your terms of service (Markdown supported)...",
      privacyPolicyHint: "Data handling and privacy statement. Linked from the registration form and account page.",
      privacyPolicyPlaceholder: "Enter your privacy policy (Markdown supported)...",
    },
    features: {
      channels: "Enabled Channels",
      channelsHint: "Select which provider channels are available to users. Empty means all channels are enabled.",
      channelsLabel: "Active channels",
      channelsPlaceholder: "Select channels...",
      monitoring: "Monitoring",
      monitoringHint: "Background health checks and alerting for provider accounts.",
      channelMonitoringHint: "Periodically probe provider accounts and trigger alerts on failures.",
      affiliate: "Affiliate & Referral",
      affiliateHint: "Reward users for inviting others to the platform.",
      invitationRebateHint: "Credit the referrer a percentage of their invitee's spending.",
    },
    users: {
      defaults: "New User Defaults",
      defaultsHint: "Initial balance and group assigned to every newly registered user.",
      defaultBalanceHint: "Starting wallet balance (e.g. 1.00 for a trial credit). 0 means no free credit.",
      defaultGroupHint: "Provider group assigned on registration. Controls which models and accounts the user can access.",
      rateLimit: "Rate Limiting",
      rateLimitHint: "Global per-user request-per-minute cap. Per-key limits override this.",
      rpmHint: "0 means unlimited. Applies to all gateway endpoints.",
      selfDelete: "Account Self-Deletion",
      selfDeleteHint: "Allow users to permanently delete their own account from the account settings page.",
    },
    gateway: {
      cooldowns: "Cooldowns & Timeouts",
      cooldownsHint: "How long the gateway backs off after upstream errors before retrying the same account.",
      overloadHint: "Seconds to wait after an overloaded (5xx) response before re-picking the account.",
      rateLimitCooldownHint: "Seconds to wait after a 429 rate-limit before re-picking the account.",
      streamTimeoutHint: "Max seconds of silence during a streaming response before aborting.",
      failover: "Failover & Retry",
      failoverHint: "Controls how many different accounts the gateway tries before failing a request.",
      retryCountHint: "Max total attempts across all accounts. Higher values improve success rate at the cost of latency.",
      maxRetryCredentialsHint: "Max distinct credentials to try. 0 = unlimited (bounded only by retry count).",
      maxRetryIntervalHint: "Ceiling for exponential backoff delay between same-account retries (ms).",
      shaperHint: "Apply token-level request shaping to smooth bursty traffic patterns.",
      protocol: "Protocol & Headers",
      protocolHint: "Cross-endpoint text conversion routes and upstream header forwarding.",
      passthroughHeaders: "Forward upstream headers",
      passthroughHeadersHint: "Pass allowlisted upstream response headers (e.g. retry-after, x-ratelimit-*) through to clients.",
      rollout: "Scheduler Rollout",
      rolloutHint: "A/B test a new scheduling strategy on a percentage of live traffic before full deployment.",
    },
    email: {
      smtp: "SMTP Server",
      smtpHint: "Outbound email server for password resets, verification, and notifications. Password is write-only (deployment secret).",
      baseUrlHint: "Used to build clickable links in email templates (e.g. password-reset URLs).",
      notifications: "Notification Triggers",
      notificationsHint: "Automated email alerts sent to users when key thresholds are crossed.",
      lowBalanceHint: "Notify users when their wallet drops below the configured threshold after a charge.",
      subscriptionExpiryHint: "Remind users before their active subscription expires.",
      quotaAlertHint: "Alert operators when a provider account's remaining quota crosses the warning threshold.",
      templates: "Email Templates",
      templatesHint: "Override the built-in email templates for specific event types.",
    },
    security: {
      ...
      adminApiKeyEnvHint: "Set via the SRAPI_MASTER_KEY environment variable. Restart the server after changing it.",
    ...
    payment: {
      ...
      providersHint: "Select which payment providers to enable. Configure credentials in Billing Admin → Payment Providers.",
  ...
  copilot: {
    ...
    example1: "Show all unhealthy accounts and their error messages",
    example2: "Batch-refresh OAuth tokens for all accounts in group 'production'",
    example3: "Compare usage between today and yesterday",
    example4: "Disable all accounts with status 'dead' and report the count",
    reasoning: "Thinking",
    arguments: "Arguments",
    result: "Result",
    ok: "OK",
    ...
    sourceAccount: "Reuse an account group",
    ...
    fieldTemperatureHint: "Sampling randomness (0.0–2.0). Lower = more deterministic. Empty uses model default.",
    fieldTopP: "Top P",
    fieldTopPHint: "Nucleus sampling cutoff (0.0–1.0). Empty uses model default.",
    ...
    petShortcuts: "Keyboard shortcuts",
    shortcutSend: "Send",
  ...
  adminPricing: {
    ...
    emptyFilteredTitle: "No matching pricing rules",
    emptyFilteredBody: "Loosen the search, model, or provider filter to inspect pricing coverage.",
    searchPlaceholder: "Search models, providers, families, or prices...",
    allModels: "All models",
    allProviders: "All providers",
    ...
    presetPanelTitle: "Default price presets",
    presetPanelHint:
      "Built-in prices for common OpenAI, Claude, Gemini, DeepSeek, Grok, and related model families. Installing them keeps usage, billing, and gateway resource checks from falling back to default zero pricing.",
    presetCoverage: "{installed}/{total} covered",
    presetTotal: "Presets",
    presetMissingFamilies: "Missing",
    presetRulesLoaded: "Rules loaded",
    presetLoading: "Loading default price coverage…",
    presetMissingPreview: "Missing examples: {families}",
    presetAllCovered: "All covered",
    presetAllCoveredHint:
      "Every default price preset currently has a matching global model-family rule.",
    installMissingPresets: "Install missing presets",
    installAllPresets: "Reinstall all presets",
    presetTokenPrices: "in {input} / out {output}",
  ...
  billing: {
    ...
    noMethodsHint: "Payment providers need to be configured before users can top up.",
    setupChecklist: "Admin setup checklist:",
    setupStep1: "Settings → Payment → enable both payment switches + select providers",
    setupStep2: "Billing Admin → Payment Providers → create & activate a provider instance",
    setupStep3: "Ensure the provider instance status is \"active\"",
  ...
  pricing: {
    ...
    subscribeHint: "Choose a payment method to complete your subscription.",
