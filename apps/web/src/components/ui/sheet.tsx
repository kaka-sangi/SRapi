...
const SIDE_CLASSES: Record<Side, string> = {
  left: "inset-y-0 left-0 h-full w-80 max-w-[85vw] border-r srapi-anim-sheet-left",
  right: "inset-y-0 right-0 h-full w-80 max-w-[85vw] border-l srapi-anim-sheet-right",
  bottom: "inset-x-0 bottom-0 max-h-[85vh] w-full rounded-t-2xl border-t srapi-anim-sheet-bottom",
};
