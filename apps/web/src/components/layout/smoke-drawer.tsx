...
import type { SmokeChecklist } from "@/lib/mockData";
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex flex-col items-end gap-1 font-mono text-[11px]">
                    <Badge
                      variant={
                        status.public_https_upstream_account_count > 0 ? "success" : "danger"
                      }
                    >
                ...
                <EndpointMatrix
                  ...
                  pendingLabel={t("incompleteState")}
                  isComplete={
                    status.missing_real_upstream_scheduler_decision_endpoints.length === 0
                  }
                />
              </div>
