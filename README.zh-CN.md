...
模块边界与依赖方向见 [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)。
...
[`docs/CONFIGURATION_SPEC.md`](docs/CONFIGURATION_SPEC.md) 定义优先级与生产约束。要点：
...
| 想要…… | 阅读 |
| --- | --- |
| 了解平台与路线图 | [`docs/PROJECT_DEVELOPMENT_PLAN.md`](docs/PROJECT_DEVELOPMENT_PLAN.md) |
| 了解后端架构 | [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)、[`docs/MODULE_INTERFACE_CONTRACTS.md`](docs/MODULE_INTERFACE_CONTRACTS.md) |
| 了解端点互转 | [`docs/AI_ENDPOINT_COMPATIBILITY.md`](docs/AI_ENDPOINT_COMPATIBILITY.md)、[`docs/GATEWAY_ROUTE_MATRIX.md`](docs/GATEWAY_ROUTE_MATRIX.md) |
| 了解调度器 | [`docs/SCHEDULING_KERNEL_DESIGN.md`](docs/SCHEDULING_KERNEL_DESIGN.md)、[`docs/SCHEDULER_V1_SPEC.md`](docs/SCHEDULER_V1_SPEC.md) |
| 接入或迁移上游账号 | [`docs/REVERSE_PROXY_SPEC.md`](docs/REVERSE_PROXY_SPEC.md)、[`docs/MIGRATION_GUIDE_2API.md`](docs/MIGRATION_GUIDE_2API.md) |
| 部署与运维 | [`docs/OPERATIONS.md`](docs/OPERATIONS.md)、[`docs/CONFIGURATION_SPEC.md`](docs/CONFIGURATION_SPEC.md)、[`docs/OBSERVABILITY_SPEC.md`](docs/OBSERVABILITY_SPEC.md) |
| 查阅安全模型 | [`docs/SECURITY_MODEL.md`](docs/SECURITY_MODEL.md)、[`SECURITY.md`](SECURITY.md) |
| 作为客户端集成 | [`examples/README.md`](examples/README.md)、[`docs/OPENAPI_CONTRACT.md`](docs/OPENAPI_CONTRACT.md) |
...
（[`STATUS.md`](specs/STATUS.md)、[`ROADMAP.md`](specs/ROADMAP.md)）。
...
威胁模型见 [`docs/SECURITY_MODEL.md`](docs/SECURITY_MODEL.md)。
