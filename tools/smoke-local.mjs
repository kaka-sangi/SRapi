...
export const RELEASE_GATEWAY_SMOKE_ENDPOINTS = Object.freeze([
  ...
  { name: "videos", method: "POST", path: "/v1/videos" },
  { name: "video_retrieve", method: "GET", path: "/v1/videos/{video_id}" },
  { name: "video_content", method: "GET", path: "/v1/videos/{video_id}/content" },
